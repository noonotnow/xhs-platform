export const LEGACY_BROWSER_CLOSED_PRE_PUBLISH_ERROR_CODE = 'INTERNAL_ERROR';
export const LEGACY_BROWSER_CLOSED_PRE_PUBLISH_ERROR_MESSAGE =
  'page.waitForTimeout: Target page, context or browser has been closed';
export const BROWSER_CLOSED_PRE_PUBLISH_ERROR_CODE = 'BROWSER_CLOSED_PRE_PUBLISH';
